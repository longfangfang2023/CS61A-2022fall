...
def num_eights(n,count=0):
    ...
    if n == 0:
        ...
        return num_eights(n//10,count+1)
    else:
        return num_eights(n//10,count)


def digit_distance(n,sum=0):
    ...
    if n//10==0:
        ...
        return digit_distance(n//10, sum+abs(n//10%10-n%10))


def interleaved_sum(n, odd_term, even_term,sum=0):
    ...
    if n==0:
        return sum
    if n % 2 == 0:
        return interleaved_sum(n-1,odd_term,even_term,sum+even_term(n))
    else:
        return interleaved_sum(n-1, odd_term, even_term,sum+odd_term(n))
